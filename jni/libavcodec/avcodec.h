...
enum AVPacketSideDataType {
	AV_PKT_DATA_PALETTE, AV_PKT_DATA_NEW_EXTRADATA,
...
typedef struct AVPacket {
	...
	void (*destruct)(struct AVPacket *);attribute_deprecated
	void *priv;
#endif
...
#define FF_MB_DECISION_RD     2        ///< rate distortion
	...
	attribute_deprecated
	float rc_qmod_amp;attribute_deprecated
	int rc_qmod_freq;
#endif
...
#define FF_THREAD_SLICE   2 ///< Decode more than one part of a single frame at once
	...
	int (*execute2)(struct AVCodecContext *c,
			int (*func)(struct AVCodecContext *c2, void *arg, int jobnr,
					int threadnr), void *arg2, int *ret, int count);
...
typedef struct AVCodec {
	 ...
	 */
	int (*update_thread_context)(AVCodecContext *dst,
...
ReSampleContext *av_audio_resample_init(int output_channels, int input_channels,
		int output_rate, int input_rate, enum AVSampleFormat sample_fmt_out,
		enum AVSampleFormat sample_fmt_in, int filter_length,
...
int av_picture_pad(AVPicture *dst, const AVPicture *src, int height, int width,
		enum AVPixelFormat pix_fmt, int padtop, int padbottom, int padleft,
...
enum AVPixelFormat avcodec_find_best_pix_fmt2(enum AVPixelFormat dst_pix_fmt1,
		enum AVPixelFormat dst_pix_fmt2, enum AVPixelFormat src_pix_fmt,
		int has_alpha, int *loss_ptr);
#endif
...
int avcodec_default_execute(AVCodecContext *c,
		int (*func)(AVCodecContext *c2, void *arg2), void *arg, int *ret,
		int count, int size);
int avcodec_default_execute2(AVCodecContext *c,
		int (*func)(AVCodecContext *c2, void *arg2, int, int), void *arg,
		int *ret, int count);
//FIXME func typedef
...
int avcodec_fill_audio_frame(AVFrame *frame, int nb_channels,
		enum AVSampleFormat sample_fmt, const uint8_t *buf, int buf_size,
		int align);
...
typedef struct AVBitStreamFilter {
	const char *name;
	int priv_data_size;
	int (*filter)(AVBitStreamFilterContext *bsfc, AVCodecContext *avctx,
